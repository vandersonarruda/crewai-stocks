...
# (Task) Analyze the stock price history
getStockPrice = Task(
...
# Important a tool de search (DuckDuckGoSearchResults)
search_tool = DuckDuckGoSearchResults(backend="news", num_results=10)

# (Agent) Analyse the news articles about the stock (ticket)
newsAnalyst = Agent(
